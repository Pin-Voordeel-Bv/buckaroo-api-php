...
final readonly class SmartTerminal
{
     ...
     * @param array<string, mixed> $customisationSettings
    ...
    public function __construct(
        ...
        public array $customisationSettings = [],
        public ?bool $attended = null,
        public TerminalMode|string|null $terminalMode = null,
